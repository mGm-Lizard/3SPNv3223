...
function string SwapDefaultCombo(string ComboName)
{
    if(ComboName ~= "xGame.ComboSpeed")
        return "3SPNv3223.Misc_ComboSpeed";
    else if(ComboName ~= "xGame.ComboBerserk")
        return "3SPNv3223.Misc_ComboBerserk";
...
defaultproperties
{
     ...
     OvertimeSound=Sound'3SPNv3223.Sounds.overtime'
     ADR_MinorError=-5.000000
     LoginMenuClass="3SPNv3223.Menu_TAMLoginMenu"
     LocalStatsScreenClass=Class'3SPNv3223.Misc_StatBoard'
     DefaultPlayerClassName="3SPNv3223.Misc_Pawn"
     ScoreBoardType="3SPNv3223.AM_Scoreboard"
     HUDType="3SPNv3223.AM_HUD"
     MapListType="3SPNv3223.MapListArenaMaster"
     GoalScore=5
     MaxLives=1
     TimeLimit=0
     DeathMessageClass=Class'3SPNv3223.Misc_DeathMessage'
     MutatorClass="3SPNv3223.TAM_Mutator"
     PlayerControllerClassName="3SPNv3223.Misc_Player"
     GameReplicationInfoClass=Class'3SPNv3223.TAM_GRI'
